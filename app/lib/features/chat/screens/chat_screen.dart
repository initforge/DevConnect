...
class _CodePreviewBubble extends StatelessWidget {
  const _CodePreviewBubble({this.isDesktop = false});
  ...
  Widget build(BuildContext context) {
    final maxWidth =
        isDesktop ? 600.0 : MediaQuery.of(context).size.width * 0.74;
    return Align(
...
class _LinkPreviewBubble extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final maxWidth =
        isDesktop ? 600.0 : MediaQuery.of(context).size.width * 0.64;
    return Align(
