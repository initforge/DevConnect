...
class SeedData {
  ...
  static final users = [
    User(
      ...
      skills: const ['Flutter', 'Dart', 'NestJS', 'PostgreSQL'],
      followerCount: 1250,
      followingCount: 340,
      postCount: 48,
      reputation: 3200,
    ...
    User(
      ...
      skills: const ['Go', 'Kubernetes', 'PostgreSQL', 'Redis'],
      followerCount: 890,
      followingCount: 210,
      postCount: 35,
      reputation: 2800,
    ...
    User(
      ...
      skills: const ['Python', 'PyTorch', 'TensorFlow', 'FastAPI'],
      followerCount: 2100,
      followingCount: 180,
      postCount: 62,
      reputation: 4500,
    ...
    User(
      ...
      skills: const ['React', 'TypeScript', 'Next.js', 'Tailwind'],
      followerCount: 650,
      followingCount: 420,
      postCount: 27,
      reputation: 1800,
    ...
    User(
      ...
      skills: const ['Docker', 'AWS', 'Terraform', 'GitHub Actions'],
      followerCount: 430,
      followingCount: 150,
      postCount: 19,
      reputation: 1200,
    ...
    User(
      ...
      skills: const ['Flutter', 'Swift', 'Firebase', 'Dart'],
      followerCount: 780,
      followingCount: 290,
      postCount: 41,
      reputation: 2400,
  ...
  static final posts = [
    Post(
      ...
      tags: const ['Flutter', 'Riverpod', 'State Management'],
      viewCount: 1240,
      likeCount: 89,
      commentCount: 23,
      bookmarkCount: 45,
    ...
    Post(
      ...
      tags: const ['Go', 'Concurrency', 'Patterns'],
      viewCount: 890,
      likeCount: 67,
      commentCount: 15,
      bookmarkCount: 32,
    ...
    Post(
      ...
      type: PostType.til,
      tags: const ['Python', 'PyTorch', 'Performance'],
      viewCount: 2300,
      likeCount: 156,
      commentCount: 41,
      bookmarkCount: 78,
    ...
    Post(
      ...
      tags: const ['Next.js', 'React', 'Server Actions'],
      viewCount: 670,
      likeCount: 34,
      commentCount: 28,
      bookmarkCount: 12,
    ...
    Post(
      ...
      type: PostType.article,
      tags: const ['DevOps', 'Docker', 'GitHub Actions', 'CI/CD'],
      viewCount: 1560,
      likeCount: 112,
      commentCount: 36,
      bookmarkCount: 67,
    ...
    Post(
      ...
      type: PostType.snippet,
      tags: const ['Flutter', 'CustomPainter', 'Charts'],
      viewCount: 430,
      likeCount: 28,
      commentCount: 8,
      bookmarkCount: 15,
    ...
    Post(
      ...
      tags: const ['AI', 'Gemini', 'Python', 'Code Review'],
      viewCount: 890,
      likeCount: 54,
      commentCount: 19,
      bookmarkCount: 23,
  ...
  static final projects = [
    Project(
      ...
      techStack: const ['Python', 'FastAPI', 'React', 'Docker'],
    ...
    Project(
      ...
      techStack: const ['Flutter', 'NestJS', 'PostgreSQL', 'Redis'],
      status: 'ACTIVE',
      memberCount: 3,
      maxMembers: 5,
    ...
    Project(
      ...
      techStack: const ['Next.js', 'TypeScript', 'D3.js', 'Supabase'],
      status: 'LOOKING_FOR_MEMBERS',
      memberCount: 1,
      maxMembers: 3,
    ...
    Project(
      ...
      techStack: const ['Go', 'Kubernetes', 'Prometheus', 'Grafana'],
      status: 'ACTIVE',
      memberCount: 4,
      maxMembers: 5,
  ...
  static final jobs = [
    ...
    Job(
      ...
      techStack: const ['NestJS', 'TypeScript', 'PostgreSQL', 'Redis'],
      experience: '2-4 năm',
      matchPercent: 78,
      createdAt: DateTime.now().subtract(const Duration(days: 2)),
    ),
    Job(
      ...
      remote: true,
      salaryRange: '\$500 - \$800',
      techStack: const ['Python', 'PyTorch', 'Docker'],
      experience: 'Thực tập',
      matchPercent: 45,
      createdAt: DateTime.now().subtract(const Duration(days: 3)),
    ),
    Job(
      ...
      techStack: const ['React', 'Node.js', 'MongoDB'],
      experience: '1-3 năm',
      matchPercent: 60,
