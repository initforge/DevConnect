...
class UserListItemSkeleton extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: Row(
        children: [
          const ShimmerBox(width: 46, height: 46, borderRadius: 23),
          ...
          const ShimmerBox(width: 64, height: 28, borderRadius: 14),
        ],
      ),
    );
  }
    ...
    return Padding(
      ...
      child: Row(
        children: [
          ...
          const ShimmerBox(width: 36, height: 12),
        ],
      ),
    );
  }
...
class LeaderboardRowSkeleton extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: Row(
        children: [
          const ShimmerBox(width: 28, height: 14),
          const SizedBox(width: 8),
          const ShimmerBox(width: 40, height: 40, borderRadius: 20),
          ...
          const ShimmerBox(width: 60, height: 28, borderRadius: 14),
        ],
      ),
    );
  }
