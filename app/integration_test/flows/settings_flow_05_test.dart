...
void main() {
  ...
  group('Luồng 05: Cài đặt & Cá nhân hóa (Settings & Profile Flow)', () {
    testWidgets(
      'TC-SETTINGS-FULL: Edit Profile -> Change Theme -> Reset Data',
      (tester) async {
        await login(tester);
        ...
        if (editBtn.evaluate().isNotEmpty) {
          ...
          await tester.enterText(
            fields.at(1),
            'Lập trình viên Flutter đam mê E2E testing.',
          );
        ...
        debugPrint(
          '✅ TC-SETTINGS-FULL: Hoàn thành kiểm tra cài đặt và cá nhân hóa!',
        );
      },
    );
  });
