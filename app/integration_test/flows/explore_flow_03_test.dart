...
void main() {
  ...
  group('Luồng 03: Khám phá Chuyên sâu (Deep Explore Flow)', () {
    testWidgets(
      'TC-EXPLORE-DEEP: Tương tác chi tiết từng ngóc ngách hệ sinh thái',
      (tester) async {
        await login(tester);
        ...
        expect(
          find.text('Tạo dự án mới sẽ triển khai ở phase sau'),
          findsOneWidget,
        );
        ...
        debugPrint(
          '✅ TC-EXPLORE-DEEP: Hoàn thành kiểm tra mọi ngóc ngách Business Logic!',
        );
      },
    );
  });
